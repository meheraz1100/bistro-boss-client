 ...
 * create payment intent post on the server. and return client secret
 * install stripe on the server side and get client secret. make sure you used the payment methods types: ['card']
